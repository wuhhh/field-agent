...
class FieldService extends Component
{
	 ...
	 * @deprecated No longer used - registry is always used
	 */
	// private bool $useRegistry = true; // TO BE DELETED
	 ...
	 * @deprecated No longer used - TO BE DELETED
	 */
	// TO BE DELETED - entire method from here to line ~360
	...
	public function createFieldFromConfig(array $config)
	{
		...
		// Legacy switch statement will be removed - DO NOT USE
		if (false) {
			switch ($fieldType) {
				case 'plain_text':
				case 'text':
					...
					if (isset($fieldConfig['field_type'])) {
						...
						if ($blockField) {
							...
							if (!$fieldsService->saveField($blockField)) {
								// TODO: Fix undefined method getErrors
